...
public class AuthRestAPIs {
    ...
    public ResponseEntity<String> registerUser(@RequestBody SignUpForm signUpRequest) {
        ...
        User user = new User(signUpRequest.getEmail(), signUpRequest.getUsername(), encoder.encode(signUpRequest.getPassword()), Date.valueOf(birthday), signUpRequest.getGender());
